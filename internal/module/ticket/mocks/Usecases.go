...
func (_m *Usecases) CheckStockTicket(ctx context.Context, ticketDetailID int) (response.StockTicket, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int) (response.StockTicket, error)); ok {
...
func (_m *Usecases) InquiryTicketAmount(ctx context.Context, ticketID int64, totalTicket int) (response.InquiryTicketAmount, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, int) (response.InquiryTicketAmount, error)); ok {
		return rf(ctx, ticketID, totalTicket)
	}
...
func (_m *Usecases) ShowTickets(ctx context.Context, page int, pageSize int, userID int64) ([]response.Ticket, int, int, error) {
	...
	var r2 int
	var r3 error
	if rf, ok := ret.Get(0).(func(context.Context, int, int, int64) ([]response.Ticket, int, int, error)); ok {
		return rf(ctx, page, pageSize, userID)
	}
